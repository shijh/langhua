...
/**
 * Name：Asynchronous access to pay-type helper class to return to deal with
 * Function：Supporting asynchronous return for authentication, such as action to write log
