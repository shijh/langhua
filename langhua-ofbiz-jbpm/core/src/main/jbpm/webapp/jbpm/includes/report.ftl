<#assign wp = Static["cn.langhua.ofbiz.report.OFBizHtmlReport"].getInstance(request, response)>
<#assign borderStyle = ""
         borderSimpleStyle = ""
...
report_running.src = "/jbpm/images/wait.gif";

var report_ok = new Image();
report_ok.src = "/jbpm/images/ok.png";

var report_error = new Image();
report_error.src = "/jbpm/images/error.png";
...
var pageStartSimple =
    ...
    "<link rel='stylesheet' type='text/css' href='/jbpm/includes/workplace.css'>\n" +
    cssStyle +
    "</head>\n" +
    "<body style='background-color:Menu;'>\n" +   
    "<div style='vertical-align:middle; height: 100%;'>\n"+
    "<table border='0' style='vertical-align:middle; height: 100%;'>\n" + 
    "<tr><td width='40' align='center' valign='middle'><img name='report_img' src='/jbpm/images/wait.gif' width='32' height='32' alt=''></td>\n" + 
    "<td valign='middle'>";
