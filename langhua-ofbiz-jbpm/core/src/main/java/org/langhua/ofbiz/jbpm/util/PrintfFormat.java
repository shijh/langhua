...
public class PrintfFormat {
    ...
    private final class ConversionSpecification {
         ...
         *     x, X, or o.
         */
        String internalsprintf(double s) throws Exception {
         ...
         */
        String internalsprintf(int s) throws Exception {
         ...
         *     conversion character is f, e, E, g, or G.
         */
        String internalsprintf(long s) throws Exception {
         ...
         */
        String internalsprintf(Object s) throws Exception {
     ...
     * @throws Exception if the control string is null, zero length, or otherwise
     * malformed.
     */
     ...
     *     d, d, x, X, or o.
     */
    public String sprintf(double x) throws Exception {
     ...
     *     or S.
     */
    public String sprintf(int x) throws Exception {
     ...
     *     or S.
     */
    public String sprintf(long x) throws Exception {
     ...
     */
    public String sprintf(Object x) throws Exception {
     ...
     * @throws Exception 
     */
    public String sprintf(Object[] o) throws Exception {
