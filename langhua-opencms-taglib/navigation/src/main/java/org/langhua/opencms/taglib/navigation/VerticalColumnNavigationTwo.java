 ...
 * example: <br>
 * 
 * &lt;%@ taglib &nbsp prefix="ocms" &nbsp uri="http://www.langhua.cn/taglib/display"%&gt;<br>
 * 
 * &lt;%ocms:textimgtageleven &nbsp linkpath="/taglib/LinkSrc" &nbsp &nbsp cssfile="/taglib/CssSrc" /&gt;<br>
 * 
 * linkpath : this is taglib's content.<br>
 * cssfile: the css config.
 * 
 * Image name: VerticalColNavTwo-display.PNG<br>
 * 
 */
public class VerticalColumnNavigationTwo extends A_LanghuaTag {

	private static final long serialVersionUID = 1L;

	private static final Log LOG = CmsLog.getLog(VerticalColumnNavigationTwo.class);
	...
	public String buildHtml() {
		...
		if (CmsStringUtil.isEmpty(getCssIndicator()) || A_LanghuaTag.CSS_INDICATOR_CUSTOMIZED.equals(getCssIndicator())) {
				...
				html.append("<tr><td>");
				html.append("<div class=\"titleimg" + fileName + "\"></div>\n");
					...
					while (container0.hasMoreResources()) {		
					 ...
					 I_CmsXmlContentContainer container1 =cmsx.contentloop(container0, "SuperLink");
					    while(container1.hasMoreResources()) {				 				  
							  ...
							  html.append("<div class=\"contentimg" + fileName + "\">\n");
							  html.append("<a target=\"_blank\" href=\""+uri+"\" class=\"link"+fileName+"\">\n");
							  html.append("<div class=\"font" + fileName + "\">\n");
