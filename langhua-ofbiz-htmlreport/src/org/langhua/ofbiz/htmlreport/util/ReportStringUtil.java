...
package org.langhua.ofbiz.htmlreport.util;
 ...
 * 
 */
public final class ReportStringUtil extends StringUtil {
    ...
    public static String escapeHtml(String source) {
        ...
        source = ReportStringUtil.substitute(source, "\r", "");
        source = ReportStringUtil.substitute(source, "\n", "<br/>\n");
        return source;
    }
    ...
    public static String trimToSize(String source, int length, int area, String suffix) {
        ...
        if (ReportStringUtil.isEmpty(suffix)) {
